...
const generateVariations= async() =>{
  ...
  return ( <
    ...
    <section className = "search-section" >
      <p> Start with a detailed description <span class="surprise" onClick={surpriseMe}> Surprise me </span>
      </p>
      <div className="input-container">
       <input
            value={value}
            placeholder='An impressionsit oil painting of a sunflower in a purple vase..'
